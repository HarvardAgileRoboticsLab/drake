classdef HamrVariational < RigidBodyManipulator
    
    properties (SetAccess = protected, GetAccess = public)
        x0
        grav = [0; 0; -9.81e-3];
        LOOP_BODIES = {'FLS_Loop', 'Chassis', [-12.75465981539; -9.79; -1.71], [9.39733204324347E-02; -5.48845250802898E-04; -0.379657560961688];
            ...
            'RLS_Loop', 'Chassis', [12.75465981539; -9.79; -1.71], [9.39733204324347E-02; -5.48845250802898E-04; -0.379657560961688];
    ...
    methods
        ...
        function obj=HamrVariational(urdf,options)
            ...
            klconst = FunctionHandleConstraint(zeros(6*nKL, 1), ...
                zeros(6*nKL, 1), nQ, @obj.kl_const_fun, cnstr_opts);
...
%             disp(max(abs(df_fd(:)-df(:))));
        ...
        function [f, df, df2] = kl_const(obj, q)
            ...
            for i = 1:nKL
                ...
                [x1, J1, dJ1] = obj.forwardKin(kinsol, loop_body1, obj.LOOP_BODIES{i,3}+obj.LOOP_BODIES{i,4}, struct('rotation_type', 1));
                [x2, J2, dJ2] = obj.forwardKin(kinsol, loop_body2, obj.LOOP_BODIES{i,4}, struct('rotation_type', 1));
                
%                  obj.LOOP_BODIES{i,3}+obj.LOOP_BODIES{i,4}
                f(6*(i-1)+1:6*i) = x2 - x1;
