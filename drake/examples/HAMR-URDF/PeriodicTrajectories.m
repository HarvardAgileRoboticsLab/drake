...
files = {'TROT_0.2N_10Hz_MU10_VariationalSmooth2', 'TROT_0.2N_10Hz_MU6_VariationalSmooth'};
dim = 3;
...
%     save([save_dir, files{k}, '_forXPC.mat'], 'tt', 'xx', 'uu', 'pfW', 'pfB', 'vfB');
