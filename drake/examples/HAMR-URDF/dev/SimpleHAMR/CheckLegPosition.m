...
%%
sl_urdf = fullfile(getDrakePath, 'examples', 'HAMR-URDF', 'dev', 'SimpleHAMR', 'urdf', 'RR_scaled.urdf');
...
xfooti = SL.forwardKin(kinsoliSL, SL.findLinkId('RRL4'), pfSL , fkoptSL)
...
xfooti = hamr.forwardKin(kinsoli, hamr.findLinkId('RR2'), pf, fkopt)