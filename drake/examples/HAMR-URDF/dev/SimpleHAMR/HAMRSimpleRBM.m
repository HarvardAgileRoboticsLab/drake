classdef HAMRSimpleRBM < RigidBodyManipulator
    ...
    methods
        ...
        function obj=HAMRSimpleRBM(urdf,options)
            ...
            if options.floating
                q0(3) = 12.5417; 
                q0(7) = 0.520966701443923;
                q0(9) = 0.520966701443923;
                q0(11) = -0.520966701443923;
                q0(13) = -0.520966701443923;
            else
                q0(1) = 0.520966701443923;
                q0(3) = 0.520966701443923;
                q0(5) = -0.520966701443923;
                q0(7) = -0.520966701443923;
            end
            obj.q0 = q0; 
        end   
