...
%%
sl_urdf = fullfile(getDrakePath, 'examples', 'HAMR-URDF', 'dev', 'SimpleHAMR', 'urdf', 'SL_scaled.urdf');
...
xfooti = SL.forwardKin(kinsoliSL, SL.findLinkId('FLL4'), pfSL , fkoptSL)
...
xfooti = hamr.forwardKin(kinsoli, hamr.findLinkId('FL2'), pf, fkopt)