function plottingHybrid(t0, tf, tf_phi, xtraj, xtraj_discrete, xtraj_tvlqr, xtraj_phi)
    ...
    xtraj_discrete_eval = [ones(1, numel(t)) + (t > xtraj_discrete.te); xtraj_discrete_eval];
    
    xtraj_tvlqr_eval = xtraj_tvlqr.eval(t);
    xtraj_tvlqr_eval = [ones(1, numel(t)) + (t > xtraj_tvlqr.te); xtraj_tvlqr_eval];
    
    xtraj_phi_eval = xtraj_phi.eval(tphi);
    xtraj_phi_eval = [ones(1, numel(tphi)) + (tphi > xtraj_phi.te); xtraj_phi_eval];
    ...
    plot(t, xtraj_discrete_eval(14,:), 'k--'),
    plot(t, xtraj_tvlqr_eval(14,:), 'k'),
    plot(tphi, xtraj_phi_eval(14,:), 'b'), hold off
    ...
    plot3(xtraj_discrete_eval(2,:), xtraj_discrete_eval(3,:), xtraj_discrete_eval(4,:), 'k--'),
    ...
    figure
    nom_dist = sqrt((xtraj_eval(2, :) - xtraj_eval(2, end)).^2 + ...
                    (xtraj_eval(3, :) - xtraj_eval(3, end)).^2 + ...
                    (xtraj_eval(4, :) - xtraj_eval(4, end)).^2);
    tvlqr_dist = sqrt((xtraj_tvlqr_eval(2, :) - xtraj_eval(2, end)).^2 + ...
                    (xtraj_tvlqr_eval(3, :) - xtraj_eval(3, end)).^2 + ...
                    (xtraj_tvlqr_eval(4, :) - xtraj_eval(4, end)).^2);
    phi_dist = sqrt((xtraj_phi_eval(2, :) - xtraj_eval(2, end)).^2 + ...
                    (xtraj_phi_eval(3, :) - xtraj_eval(3, end)).^2 + ...
                    (xtraj_phi_eval(4, :) - xtraj_eval(4, end)).^2);
    discrete_dist = sqrt((xtraj_discrete_eval(2, :) - xtraj_eval(2, end)).^2 + ...
                    (xtraj_discrete_eval(3, :) - xtraj_eval(3, end)).^2 + ...
                    (xtraj_discrete_eval(4, :) - xtraj_eval(4, end)).^2);
    plot(t, nom_dist, t, tvlqr_dist, tphi, phi_dist, t, discrete_dist)
    legend('nominal', 'tvlqr', 'phi-tvlqr', 'discrete tvlqr')
end