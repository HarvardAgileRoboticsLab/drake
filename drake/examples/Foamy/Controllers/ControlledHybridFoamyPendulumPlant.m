classdef ControlledHybridFoamyPendulumPlant < HybridDrakeSystem
   ...
   properties
    ...
    methods
        ...
        function obj = ControlledHybridFoamyPendulumPlant(controller1, controller2, m_p)
            ...
            mode_1 = ControlledPendulumFoamyPlant(controller1, 0)
            ...
            mode_2 = ControlledPendulumFoamyPlant(controller2, obj.m_package);
            ...
            function [g,dg] = packageGuardz(obj,t,x,u)
                ...
                g = norm(pend_pack)-hoop_length-0.01;
                %g = p_end(3)-0;
                %g = x(10);
        ...
        function [xdot, dxdot] = impact_dynamics(obj,t,x,u,dt)
            F_impact = 0;
            if nargout == 1
                xdot = impact_foamy_pendulum_dynamics(t,x,u,obj.m_package,dt);
                ...
                [xdot, dxdot] = geval(@(t1,x1,u1) impact_foamy_pendulum_dynamics(t1,x1,u1,obj.m_package,dt),t,x,u,options);
        ...
        function [xtraj,utraj] = runDircol(obj,display)
            ...
            prog = prog.compile();
            tic
            [xtraj, utraj, z, F, info]=solveTraj(prog,t_init,traj_init);
