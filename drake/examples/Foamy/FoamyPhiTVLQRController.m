    ...
    methods
        function obj = FoamyPhiTVLQRController(plant, xtraj, utraj, Q, R, Qf, t0, tf)
          ...
          % call the parent class constructor:
            ...
            % calculate K array
            obj.K_array = obj.calculate_K_phi(plant, xtraj, utraj, Qf, Q, R);
        end
        ...
        function y = output(obj, t, ~, x)
            ...
            % control
            y = ud - current_K * [x(1:3)-xd(1:3); v; x(8:13)-xd(8:13)];
        end
        
        function K_array_phi = calculate_K_phi(obj, plant, xtraj, utraj, Qf, Q, R)
