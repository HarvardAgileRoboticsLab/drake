classdef HybridFoamyTVLQRController < DrakeSystem
    properties
        plant
        xtraj
        utraj
    ...
    methods
        function obj = HybridFoamyTVLQRController(plant, xtraj, utraj, Q, R, Qf, t0, tf)
          ...
          % call the parent class constructor:
            ...
            obj.t0 = t0;
            obj.tf = tf;
            obj.nx = size(xtraj, 1)-2; %because hybrid
            obj.nu = size(utraj, 1);
            ...
            %obj = obj.setInputFrame(plant.getInputFrame);
        end
        
        
%         function xdot = dynamics(obj, t, x, u)
%             u = control(obj, t, 0, x);
%             xdot = [0; obj.plant.dynamics(t, x, u)];
%         end
%         
%         function y = control(obj, t, ~, x)
...
%         end
        ...
        function [A, B] = calculate_AB(obj, plant, t, x0, u0)
            ...
            plantmode = plant.modes{x0(1)};
            [f, df] = geval(@plantmode.dynamics, t, x0(2:end), u0, options);
