function [p,v,xtraj,utraj,ctraj,btraj,psitraj,etatraj,straj] = runVariationalTrajOpt1(x_guess,u_guess,c_guess,b_guess,psi_guess,eta_guess,s_guess)
...
traj_opt = VariationalTrajectoryOptimization1(p,N,T_span,optimoptions);
